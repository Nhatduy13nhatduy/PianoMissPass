        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Composer = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavoriteSong", x => new { x.UserId, x.SongId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SheetAsset", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSheetLike", x => new { x.UserId, x.SheetId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSheetPoint", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlaylistSong_PlaylistId_DisplayOrder",
                table: "PlaylistSong",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sheet_InstrumentId",
                table: "Sheet",
                column: "InstrumentId");

            migrationBuilder.CreateIndex(
                name: "IX_Sheet_SongId",
                table: "Sheet",
                column: "SongId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSheetLike_SheetId",
                table: "UserSheetLike",
                column: "SheetId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSheetPoint_PlayerId",
                table: "UserSheetPoint",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSheetPoint_SheetId_PlayerId",
                table: "UserSheetPoint",
                columns: new[] { "SheetId", "PlayerId" },
                unique: true);
        }
